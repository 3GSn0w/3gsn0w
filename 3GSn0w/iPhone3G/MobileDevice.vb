...
Namespace iPhone3G
    ...
    Friend Class MobileDevice
        ...
        <DllImport("iTunesMobileDevice.dll", CallingConvention:=CallingConvention.Cdecl)> _
        Public Shared Function AFCGetFileInfo(ByVal conn As IntPtr, ByVal path As String, ByRef buffer As IntPtr, ByRef length As UInteger) As Integer
        End Function
        ...
        <DllImport("iTunesMobileDevice.dll", CallingConvention:=CallingConvention.Cdecl)> _
        Public Shared Function AFCFileRefOpen(ByVal conn As IntPtr, ByVal path As String, ByVal mode As Integer, ByVal unknown As Integer, ByRef handle As Int64) As Integer
        End Function
