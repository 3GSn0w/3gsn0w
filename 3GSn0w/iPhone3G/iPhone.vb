...
#Region "Events"
        ...
        Protected Sub OnConnect(ByVal args As ConnectEventArgs)
            'Dim handler As ConnectEventHandler = Connect
        ...
        Protected Sub OnDisconnect(ByVal args As ConnectEventArgs)
            'Dim handler As ConnectEventHandler = Disconnect
        ...
        Protected Sub OnDfuConnect(ByVal args As DeviceNotificationEventArgs)
            'Dim handler As EventHandler = DfuConnect
        ...
        Protected Sub OnDfuDisconnect(ByVal args As DeviceNotificationEventArgs)
            'Dim handler As EventHandler = DfuDisconnect
        ...
        Protected Sub OnRecoveryModeEnter(ByVal args As DeviceNotificationEventArgs)
            'Dim handler As EventHandler = RecoveryModeEnter
        ...
        Protected Sub OnRecoveryModeLeave(ByVal args As DeviceNotificationEventArgs)
            'Dim handler As EventHandler = RecoveryModeLeave
...
#Region "Filesystem"
        ...
        Public Sub GetFileInfo(ByVal path As String, ByRef size As Integer, ByRef directory As Boolean)
            Dim data As IntPtr
