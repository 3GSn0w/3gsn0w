...
#Region "Constructors"
        ...
        Private Sub New(ByVal phone As iPhone, ByVal handle As Long, ByVal mode As OpenMode)
            MyBase.New()
            Me.phone = phone
            Me.mode = mode
            Me.handle = handle
...
#Region "Public Methods"
        ...
        Public Overrides Function Read(ByVal buffer__1 As Byte(), ByVal offset As Integer, ByVal count As Integer) As Integer
            Dim len As UInteger
            Dim ret As Integer
            Dim temp As Byte()
...
#Region "Static Methods"
        ...
        ''' <returns></returns>
        Public Shared Function Open(ByVal phone As iPhone, ByVal path As String, ByVal openmode__1 As FileAccess) As iPhoneFile
        ...
        Public Shared Function OpenRead(ByVal phone As iPhone, ByVal path As String) As iPhoneFile
        ...
        ''' <returns>An unshared <c>iPhoneFile</c> object on the specified path with Write access. </returns>
        Public Shared Function OpenWrite(ByVal phone As iPhone, ByVal path As String) As iPhoneFile
